/* V271 — startup root fix: one authoritative v266-style intro timeline.
   The intro starts from the desktop-base-ready signal again; it is no longer
   gated by asynchronous 3D readiness. CRT blank/power/boot remain frame-driven. */
(() => {
  'use strict';
  ...
  if (window.__heroDesktopBaseReady) {
    ...
    /* Same fallback strategy as v266: the base Hero owns startup timing.
       3D loading is allowed to happen independently and can never reorder the
       CRT state machine. */
