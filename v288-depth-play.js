(() => {
  ...
  /* ----------------------------------------------------------------------
     2. Hero — V288 runtime cleanup.
     V244/V288 owns the visible pointer-depth axis. The old V203 loop was
     still doing per-frame style writes underneath that newer override, so it
     is reduced to the one thing later CSS still needs: the depth-ready class.
     ---------------------------------------------------------------------- */
