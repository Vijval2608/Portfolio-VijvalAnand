/* V293: Selected Works desktop entry is scroll-synced; all other section springs unchanged. */
(() => {
  'use strict';
  ...
  groups.forEach((group) => {
    /* V293: desktop Works is owned by v293-work-scroll-entry.js so it cannot
       simultaneously run an observer-timed spring. Mobile keeps legacy spring. */
    if (desktop.matches && group.root === '.figma-work-section') return;
